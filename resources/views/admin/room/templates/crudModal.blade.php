          ...
          <div class="row mb-2">
            <div class="col-lg-12 col-md-12 col-sm-12">
              <div class="form-group">
                <label for="room_no" class="form-control-label mb-1">{{ trans('cruds.room.fields.room_no') }}: <span class="text-danger">*</span></label>
                <input id="room_no" name="room_no" class="form-control" type="text" placeholder="{{ trans('cruds.room.fields.room_no') }}">
