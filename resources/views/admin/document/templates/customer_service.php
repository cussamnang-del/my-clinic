        ...
        <div class="row justify-content-evenly  ">
          <div class="col-lg-9">
            <div class="d-flex align-items-center justify-content-between fs-6 mb-3">
              ...
              <a id="objectBioHistory" href="#" class="btn btn-secondary btn-sm text-white" style="cursor: pointer;" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Show P.Rx" aria-label="Edit">Bio History</a>
      ...
      $('body thead').on('click','#add_more_medicine',function(e){
        ...
        var $fieldMedicine = $(`
          <tr>
            <td>
              <div class="form-group">
                <select data-id="order_product_${rowcount}" id="order_product" name="order_product[]" class="form-control order_product order_detail"  style="width: 100%" data-placeholder="Select Medecine">
            ...
            <td>
              <div class="form-group">
                <input data-id="qty_${rowcount}" id="qty" name="qty[]" class="form-control" type="text" placeholder="{{ trans('cruds.orderDetail.fields.qty') }}">
              </div>
            </td>
            <td>
              <div class="form-group">
                <input data-id="unit_${rowcount}" id="unit" name="unit[]" class="form-control" type="text" placeholder="{{ trans('cruds.orderDetail.fields.unit') }}">
              </div>
            </td>
            <td>
              <div class="form-group">
                <input data-id="strength_${rowcount}" id="strength" name="strength[]" class="form-control" type="text" placeholder="{{ trans('cruds.orderDetail.fields.strength') }}">
              </div>
            </td>
            <td>
              <div class="form-group mb-2">
                <input list="how_to_uses" data-id="how_to_use_${rowcount}" id="how_to_use" name="how_to_use[]"  class="how_to_use form-control" placeholder="{{ trans('cruds.orderDetail.fields.how_to_use') }}" autocomplete="off">
              </div>
            </td>
            <td>
              <div class="form-group mb-2">
    ...
    $(document).ready(function(){
      ...
      var $fieldInjection = $(`
        <tr>
          <td>
            <div class="form-group">
              <select data-id="row_${rowcount}" id="injection_product" name="injection_product[]" class="form-control order_product injection_product"  style="width: 100%" data-placeholder="Select Medecine">
                <option value="">{{ trans('global.select') }} {{ trans('cruds.order.fields.medicine') }}</option>
                @foreach ($products as $key => $row)
                  <option value="{{ $row->id }}">{{ $row->p_name }}</option>
                @endforeach
          ...
          <td>
            <div class="form-group">
              <input data-id="row_${rowcount}" id="injection_qty" name="injection_qty[]" class="form-control" type="text" placeholder="{{ trans('cruds.orderDetail.fields.qty') }}">
            </div>
          </td>
          <td>
            <div class="form-group">
              <input data-id="row_${rowcount}" id="injection_unit" name="injection_unit[]" class="form-control" type="text" placeholder="{{ trans('cruds.orderDetail.fields.unit') }}">
            </div>
          </td>
          <td>
            <div class="form-group">
              <input data-id="row_${rowcount}" id="injection_strength" name="injection_strength[]" class="form-control" type="text" placeholder="{{ trans('cruds.orderDetail.fields.strength') }}">
            </div>
          </td>
          <td>
            <div class="form-group mb-2">
              <input list="how_to_uses" data-id="row_${rowcount}" id="injection_how_to_use" name="injection_how_to_use[]"  class="injection_how_to_use form-control" placeholder="{{ trans('cruds.orderDetail.fields.how_to_use') }}" autocomplete="off">
            </div>
          </td>
          <td>
            <div class="form-group mb-2">
              <div class="form-group mb-2">
                <select data-id="row_${rowcount}" id="injection_before_after" name="injection_before_after[]" class="form-select form-select-md mb-3" aria-label=".form-select-lg example" placeholder="{{ trans('cruds.orderDetail.fields.before_after') }}">
                  <option value="មុនបាយ">មុនបាយ</option>
                  <option value="ក្រោយបាយ">ក្រោយបាយ</option>
                </select>
              </div>
