...
@section('content')
    ...
    <div class="card-body">
      <div class="table-responsive">
        <table id="datatable" class="table table-striped table-bordered">
          <thead>
            <tr>
              <th>{{ trans('cruds.item_type.fields.id') }}</th>
              <th>{{ trans('cruds.item_type.fields.item_group_id') }}</th>
              <th>{{ trans('cruds.item_type.fields.name') }}</th>
              <th>{{ trans('cruds.item_type.fields.created_at') }}</th>
  ...
  @include('admin.item_type.templates.crudModal')
@endsection
  ...
  <script>
    $(document).ready(function () {
      ...
      $('#addNewObject').on('click',function(e){
        e.preventDefault();
        $('#crudObjectModal').find('.modal-title').html('{{ trans('global.add') }} {{ trans('cruds.item_type.title_singular') }}');
      ...
      $('body').on('click', 'a#objectEdit', function (e) {
        ...
        modal.find('.modal-title').html('{{ trans('global.edit') }} {{ trans('cruds.item_type.title_singular') }}');
        $.get( actionUrl +'/' +object_id+'/edit', function (res) {
          ...
          form.find('#item_group_id').val(res.data.item_group_id);
      ...
      $('body').on('change','.ace-switch',function(e){
        ...
        $.ajax({
          type : 'GET',
          dataType: 'JSON',
          url :'{{ route('admin.item_types.changeStatus') }}',
          data: {
            'status':status,
            'object_id':object_id
          },
